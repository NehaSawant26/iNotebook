...
const Addnote = (props) => {
  ...
  return (
    <div className=" set justify-content-center mt-4 ">
      <div className=" container my-4"  >
        ...
        <h2>Add a note</h2>
          ...
          <div className="mb-3">
            ...
            <textarea type="text" className="form-control" id="description" name="description" rows="4" value={note.description} onChange={onChange} minLength={5} required />
